...
//        http://localhost:8080/alfresco/service/database/retspsyk/page_entries/?skip=0&maxItems=2&keyValue=[{%22key%22:%22lort%22,%20%22value%22:%22ihovedet%22}]
        ...
        try {
            ...
            if (input.has("forvaring")) {
                JSONObject o = new JSONObject();
                o.put("key", "forvaring");

                o.put("value", input.get("forvaring"));
                o.put("include", true);
                queryArray.put(o);
...
//                psychologist = psychologist.split("-")[0];
            ...
            if ( input.has("finalVerdict") && input.has("selectedVerdict")) {
                ...
                System.out.println("hvad er queryStringFinalVerdict");
                System.out.println(queryStringFinalVerdict);
            ...
            if (input.has("lastName")) {
                String fornavn = input.getString("lastName");
                JSONObject o = new JSONObject();
